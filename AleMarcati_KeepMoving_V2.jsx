...
DESCRIPTION: Applies an expression to position, rotation or scale parameters of selected layers
             and creates a Null "controller layer" with sliders. The expression makes the layers
             automatically move, rotate or scale in the speed set by the slayer in the controller layer.
*/
...
(function autoFadeInOut(thisObj) {
    ...
    function createDockableUI(thisObj) {
        ...
        thisObj instanceof Panel
            ? thisObj
            : new Window("window", SCRIPT_NAME, undefined, { resizeable: true });
