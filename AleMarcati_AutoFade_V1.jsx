...
(function autoFadeInOut(thisObj) {
    ...
    function getOpacityExpression(fadeDur) {
        ...
        var expression = [
            ...
            "",
            "// Calculates fade in (0 to value set in property) from inPoint to inPoint + fadeDuration",
            "var fadeIn = linear(time, inPoint, inPoint + fadeDuration, 0, originalOpacity);",
            "",
            "// Calculates fade out (from value set in property to 0) from outPoint - fadeDuration to outPoint",
